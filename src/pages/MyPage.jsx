    ...
    <li className="relative overflow-hidden">
      {canSwipe ? (
        <button
          ...
          onClick={onDelete}
          className="absolute top-1/2 right-0 flex h-[35px] w-[72px] -translate-y-1/2 items-center justify-center rounded-[10px] bg-[#9E2A2B] text-[16px] font-semibold text-[#F9F6F0]"
        >
          DELETE
        </button>
      ) : null}
      ...
      <div
        className={`relative z-10 flex w-full touch-pan-y items-center justify-between bg-background select-none ${
